...
void _startVoiceCall() async {
  final channelName = "call_${widget.chatId}"; // Unique channel ID
  const callType = 'voice';

  // 1. Signal the call via Firestore
  ...
  // 2. Navigate to the VoiceCallPage as the caller
  if (!mounted) return;
  ...
  Navigator.push(
    ...
    MaterialPageRoute(
      builder: (_) => VoiceCallPage(
        channelName: channelName,
        isCaller: true, 
        chatId: widget.chatId, // Pass chatId for cleanup
      ),
    ),
  );
}
